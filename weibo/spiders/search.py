    ...
    def parse_weibo(self, response):
        ...
        for sel in response.xpath("//div[@class='card-wrap']"):
            ...
            if info:
                ...
                weibo['bid']         = sel.xpath('(.//p[@class="from"])[last()]/a[1]/@href').extract_first().split('/')[-1].split('?')[0]
                ...
                created_at = sel.xpath('(.//p[@class="from"])[last()]/a[1]/text()').extract_first().replace(' ', '').replace('\n', '').split('前')[0]
